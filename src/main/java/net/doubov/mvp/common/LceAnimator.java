    ...
    public static void showContent(boolean shouldAnimate,
        ...
        if (contentView.getVisibility() == View.VISIBLE) {
            ...
            if (Build.VERSION.SDK_INT < 14 || !shouldAnimate) {
                ...
                ObjectAnimator contentTranslateIn = ObjectAnimator.ofFloat(contentView,
                                                                           "translationY",
                                                                           dpToPx(loadingView.getContext(),
                                                                                  translateDp),
                                                                           0);
                ...
                ObjectAnimator loadingFadeOut = ObjectAnimator.ofFloat(loadingView,
                                                                       ...
                                                                       1f,
                                                                       0f);
                ObjectAnimator loadingTranslateOut = ObjectAnimator.ofFloat(loadingView,
                                                                            "translationY",
                                                                            0,
                                                                            -dpToPx(loadingView.getContext(),
                                                                                    translateDp));

                set.playTogether(contentFadeIn,
                                 contentTranslateIn,
                                 loadingFadeOut,
                                 loadingTranslateOut);
                set.setDuration(500);
